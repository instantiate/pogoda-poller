...
use Instantiate\Command\PagodaPollCommand;
use Instantiate\Command\LoadFixturesCommand;
use Instantiate\Command\ThresholdCheckCommand;
use Doctrine\DBAL\DriverManager;

$console = new Application('Pagoda Poller', '0.1');

$console->add(new PagodaPollCommand('pagoda:poll', $app));
$console->add(new ThresholdCheckCommand('threshold:check', $app));
$console->add(new LoadFixturesCommand('doctrine:fixtures:load', $app));
